...
# ==============================================================================
# 
# This Makefile follows these principles:
# 
# 1. DRY (Don't Repeat Yourself):
#    - Modular functions for progress bars avoid code duplication
#    - Single color calculation function used across all operations
#    - Reusable message display function for consistency
# 
# 2. SOC (Separation of Concerns):
#    - Progress rendering separated from business logic
#    - Color calculations isolated in dedicated functions  
#    - Build operations cleanly separated from cleanup operations
# 
# 3. Enhanced User Experience:
#    - Smooth red-to-green gradient during compilation
#    - Real-time progress updates with file names
#    - Clear success/error messaging with visual indicators
#    - Consistent formatting and spacing throughout
# 
# 4. Maintainability:
#    - Well-commented functions explain complex logic
#    - Modular design allows easy modification of progress behavior
