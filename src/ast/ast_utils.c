...
/*   Updated: 2025/07/09 18:24:52 by elaudrez         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 *
 * Cette fonction duplique la chaîne de caractères du token courant
 * (ptr->str) et la place dans le tableau new_ast->args à l'index *j. 
 * Elle protège l'allocation mémoire : en cas d'échec de ft_strdup, 
 * elle libère les arguments déjà alloués et signale l'erreur.
 *
 ...
 * @param j Pointeur vers l'index courant dans le tableau d'arguments
 * (incrémenté si succès)
