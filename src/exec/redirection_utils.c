...
/*   Updated: 2025/07/09 18:33:48 by elaudrez         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 *
 * Utilise dup2 pour rediriger stdin ou stdout selon le type, puis ferme
 * le fd.
 *
 * @param type Type de redirection (REDIR_INPUT, REDIR_OUTPUT, REDIR_APPEND)
 ...
 *
 * Parcourt la liste chaînée de nœuds de redirection et applique chaque
 * redirection (input, output, append) dans l'ordre. Affiche une
 * erreur si un nom de fichier est manquant ou si une redirection échoue.
 *
